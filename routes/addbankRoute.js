...
const addBankRoute = express.Router();
const addBankController = require("../controller/addbank.controller.js");
const {
    isNull,
    isUndefined,
    isIfsc,
...
addBankRoute.post("/", verifyData, addBankController.addBank);
module.exports = addBankRoute;